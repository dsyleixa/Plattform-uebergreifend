...
# Alle lokalen und externen Quellcodedateien Ihres Projekts
SOURCES += \
    main.cpp \
    mainwindow.cpp \
    "D:/Akten/Programmierung/Windows_progs/cpp_libs/qcustomplot/qcustomplot.cpp"

# Alle lokalen und externen Headerdateien Ihres Projekts
HEADERS += \
    mainwindow.h \
...
win32-g++: QMAKE_CXXFLAGS += -Wno-deprecated-copy -Wno-deprecated-declarations -O2

# Windows-spezifische Pfade fuer Ihre Bibliotheken und Python
win32 {
...
# Zwingt Windows, das Konsolen-Subsystem fuer Ihr Terminal scharfzuschalten
